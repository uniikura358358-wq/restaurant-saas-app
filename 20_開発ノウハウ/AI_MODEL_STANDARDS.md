...
1. **画像生成 (Image Quota)**:
   - 制限方式: **厳格な回数制限 (Standard: 60枚 / Premium: 90枚)**
...
AIがユーザーと対話する際、およびコード内での文脈理解において、以下の定義を「単一の正」として扱う。

- **見本のサイト / 見本のWEBページ**:
  - **定義**: **銀座ラーメンLP**
  - **パス**: `/ginza-ramen`
  - **用途**: 料金ページ（`/plans`）や提案資料において、サービスの実績・性能を示すための標準サンプルとして使用する。

## 5. 更新履歴

- 2026-02-18: プロジェクト固有用語（見本サイトの定義）を追記。
